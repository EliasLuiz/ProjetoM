...
if __name__ == "__main__":
    ...
    g.addElemento('O', ['Z', 'S'], [71, 151])
    g.addElemento('Z', ['O', 'A'], [71, 75])
    g.addElemento('A', ['Z', 'S', 'T'], [75, 140, 118])
    g.addElemento('T', ['A', 'L'], [118, 111])
    g.addElemento('L', ['T', 'M'], [111, 70])
    g.addElemento('M', ['L', 'D'], [70, 75])
    g.addElemento('D', ['M', 'C'], [75, 120])
    g.addElemento('C', ['D', 'R', 'P'], [120, 146, 138])
    g.addElemento('R', ['S', 'P', 'C'], [80, 97, 146])
    g.addElemento('S', ['A', 'O', 'R', 'F'], [140, 151, 80, 99])
    g.addElemento('F', ['S', 'B'], [99, 211])
    g.addElemento('B', ['F', 'P', 'U', 'G'], [211, 101, 85, 90])
    g.addElemento('P', ['R', 'B', 'C'], [97, 101, 138])
    g.addElemento('P', ['R', 'B', 'C'], [97, 101, 138])
    g.addElemento('G', ['B'], [90])
    g.addElemento('U', ['B', 'V', 'H'], [85, 142, 98])
    g.addElemento('H', ['U', 'E'], [98, 86])
    g.addElemento('E', ['H'], [86])
    g.addElemento('V', ['U', 'I'], [142, 92])
    g.addElemento('I', ['V', 'N'], [92, 87])
    g.addElemento('N', ['I'], [87])
    
    #print g
    print g.buscaLargura('A')
