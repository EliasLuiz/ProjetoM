...
VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""" % (dic['CO_LOCAL_OFERTA_IES'], dic['CO_IES'], \
dic['CO_MUNICIPIO_LOCAL_OFERTA'], dic['IN_SEDE'], dic['CO_CURSO_POLO'], dic['CO_CURSO'], \
dic['IN_LOCAL_OFERTA_NEAD'], dic['IN_LOCAL_OFERTA_UAB'], dic['IN_LOCAL_OFERTA_REITORIA'], \
