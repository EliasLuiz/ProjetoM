...
def txt_to_db(diretorio):
    ...
    for linha in file.readlines():
        ...
        if(linha[533:579].isalnum()): #caso o campo nao esteja vazio
            ...
            dic['CO_REGIME_TRABALHO'] = ""
            dic['DS_REGIME_TRABALHO'] = ""
        ...
        # %%%%%%%%%%%%% TESTAR %%%%%%%%%%%%%%
        db.query(db.sqlGenerator('INEP2012.DOCENTE', dic))
