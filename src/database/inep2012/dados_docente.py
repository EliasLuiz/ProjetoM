...
def txt_to_db(diretorio):
    ...
    for linha in file.readlines():
        ...
        if(linha[844:852].isalnum()):
            dic['IN_VISITANTE_IFES_VINCULO'] = int(linha[844:852])
        else:
