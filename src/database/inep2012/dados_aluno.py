...
def txt_to_db(diretorio):
    ...
    for linha in file.readlines():
        ...
        sqlAluno="INSERT INTO ALUNO(CO_IES,CO_CURSO,CO_ALUNO_CURSO,CO_ALUNO,CO_COR_RACA_ALUNO,DS_COR_RACA_ALUNO,IN_SEXO_ALUNO,DS_SEXO_ALUNO,NU_ANO_ALUNO_NASC,NU_MES_ALUNO_NASC,NU_DIA_ALUNO_NASC,NU_IDADE_ALUNO,CO_NACIONALIDADE_ALUNO,DS_NACIONALIDADE_ALUNO,CO_PAIS_ORIGEM_ALUNO,DS_PAIS_ORIGEM_ALUNO,CO_UF_NASCIMENTO,DS_UF_NASCIMENTO,CO_MUNICIPIO_NASCIMENTO,CO_ALUNO_SITUACAO,DS_ALUNO_SITUACAO,IN_ALUNO_DEF_TGD_SUPER,IN_DEF_AUDITIVA,IN_DEF_FISICA,IN_DEF_INTELECTUAL,IN_DEF_MULTIPLA,IN_DEF_SURDEZ,IN_DEF_SURDOCEGUEIRA,IN_DEF_BAIXA_VISAO,IN_DEF_SUPERDOTACAO,IN_TGD_AUTISMO_INFANTIL,IN_TGD_SINDROME_ASPERGER,IN_TGD_SINDROME_RETT,IN_TGD_TRANSTOR_DESINTEGRATIVO,DT_INGRESSO_CURSO,IN_RESERVA_VAGAS,IN_FINANC_ESTUDANTIL,IN_ING_VESTIBULAR,IN_ING_ENEM,IN_ING_OUTRO_TIPO_SELECAO,IN_ING_CONVENIO_PEC_G,IN_ING_OUTRA_FORMA,IN_RESERVA_ETNICO,IN_RESERVA_DEFICIENCIA,IN_RES_RENDA_FAMILIAR,IN_RESERVA_OUTROS,IN_FIN_REEMB_FIES,IN_FIN_REEMB_ESTADUAL,IN_FIN_REEMB_MUNICIPAL,IN_FIN_REEMB_PROG_IES,IN_FIN_REEMB_ENT_EXTERNA,IN_FIN_REEMB_OUTRA,IN_FIN_NAOREEMB_PROUNI_INTEGR,IN_FIN_NAOREEMB_PROUNI_PARCIAL,IN_FIN_NAOREEMB_ESTADUAL,IN_FIN_NAOREEMB_MUNICIPAL,IN_FIN_NAOREEMB_PROG_IES,IN_FIN_NAOREEMB_ENT_EXTERNA,IN_FIN_NAOREEMB_OUTRA,IN_APOIO_SOCIAL,IN_APOIO_ALIMENTACAO,IN_APOIO_BOLSA_PERMANENCIA,IN_APOIO_BOLSA_TRABALHO,IN_APOIO_MATERIAL_DIDATICO,IN_APOIO_MORADIA,IN_APOIO_TRANSPORTE,IN_ATIVIDADE_EXTRACURRICULAR,IN_COMPL_ESTAGIO,IN_COMPL_EXTENSAO,IN_COMPL_MONITORIA,IN_COMPL_PESQUISA,IN_BOLSA_ESTAGIO,IN_BOLSA_EXTENSAO,IN_BOLSA_MONITORIA,IN_BOLSA_PESQUISA,TP_PROCEDE_EDUC_PUBLICA,NU_SEMESTRE_CONCLUSAO,IN_ALUNO_PARFOR,IN_MATRICULA,IN_CONCLUINTE,IN_INGRESSO_TOTAL,IN_INGRESSO_PROCESSO_SELETIVO,IN_INGRESSO_OUTRAS_FORMAS,ANO_INGRESSO) "
        sqlAluno2="VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"%(dic['CO_IES'],dic['CO_CURSO'],dic['CO_ALUNO_CURSO'],dic['CO_ALUNO'],dic['CO_COR_RACA_ALUNO'],dic['DS_COR_RACA_ALUNO'],dic['IN_SEXO_ALUNO'],dic['DS_SEXO_ALUNO'],dic['NU_ANO_ALUNO_NASC'],dic['NU_MES_ALUNO_NASC'],dic['NU_DIA_ALUNO_NASC'],dic['NU_IDADE_ALUNO'],dic['CO_NACIONALIDADE_ALUNO'],dic['DS_NACIONALIDADE_ALUNO'],dic['CO_PAIS_ORIGEM_ALUNO'],dic['DS_PAIS_ORIGEM_ALUNO'],dic['CO_UF_NASCIMENTO'],dic['DS_UF_NASCIMENTO'],dic['CO_MUNICIPIO_NASCIMENTO'],dic['CO_ALUNO_SITUACAO'],dic['DS_ALUNO_SITUACAO'],dic['IN_ALUNO_DEF_TGD_SUPER'],dic['IN_DEF_AUDITIVA'],dic['IN_DEF_FISICA'],dic['IN_DEF_INTELECTUAL'],dic['IN_DEF_MULTIPLA'],dic['IN_DEF_SURDEZ'],dic['IN_DEF_SURDOCEGUEIRA'],dic['IN_DEF_BAIXA_VISAO'],dic['IN_DEF_SUPERDOTACAO'],dic['IN_TGD_AUTISMO_INFANTIL'],dic['IN_TGD_SINDROME_ASPERGER'],dic['IN_TGD_SINDROME_RETT'],dic['IN_TGD_TRANSTOR_DESINTEGRATIVO'],dic['DT_INGRESSO_CURSO'],dic['IN_RESERVA_VAGAS'],dic['IN_FINANC_ESTUDANTIL'],dic['IN_ING_VESTIBULAR'],dic['IN_ING_ENEM'],dic['IN_ING_OUTRO_TIPO_SELECAO'],dic['IN_ING_CONVENIO_PEC_G'],dic['IN_ING_OUTRA_FORMA'],dic['IN_RESERVA_ETNICO'],dic['IN_RESERVA_DEFICIENCIA'],dic['IN_RES_RENDA_FAMILIAR'],dic['IN_RESERVA_OUTROS'],dic['IN_FIN_REEMB_FIES'],dic['IN_FIN_REEMB_ESTADUAL'],dic['IN_FIN_REEMB_MUNICIPAL'],dic['IN_FIN_REEMB_PROG_IES'],dic['IN_FIN_REEMB_ENT_EXTERNA'],dic['IN_FIN_REEMB_OUTRA'],dic['IN_FIN_NAOREEMB_PROUNI_INTEGR'],dic['IN_FIN_NAOREEMB_PROUNI_PARCIAL'],dic['IN_FIN_NAOREEMB_ESTADUAL'],dic['IN_FIN_NAOREEMB_MUNICIPAL'],dic['IN_FIN_NAOREEMB_PROG_IES'],dic['IN_FIN_NAOREEMB_ENT_EXTERNA'],dic['IN_FIN_NAOREEMB_OUTRA'],dic['IN_APOIO_SOCIAL'],dic['IN_APOIO_ALIMENTACAO'],dic['IN_APOIO_BOLSA_PERMANENCIA'],dic['IN_APOIO_BOLSA_TRABALHO'],dic['IN_APOIO_MATERIAL_DIDATICO'],dic['IN_APOIO_MORADIA'],dic['IN_APOIO_TRANSPORTE'],dic['IN_ATIVIDADE_EXTRACURRICULAR'],dic['IN_COMPL_ESTAGIO'],dic['IN_COMPL_EXTENSAO'],dic['IN_COMPL_MONITORIA'],dic['IN_COMPL_PESQUISA'],dic['IN_BOLSA_ESTAGIO'],dic['IN_BOLSA_EXTENSAO'],dic['IN_BOLSA_MONITORIA'],dic['IN_BOLSA_PESQUISA'],dic['TP_PROCEDE_EDUC_PUBLICA'],dic['NU_SEMESTRE_CONCLUSAO'],dic['IN_ALUNO_PARFOR'],dic['IN_MATRICULA'],dic['IN_CONCLUINTE'],dic['IN_INGRESSO_TOTAL'],dic['IN_INGRESSO_PROCESSO_SELETIVO'],dic['IN_INGRESSO_OUTRAS_FORMAS'],dic['ANO_INGRESSO'])
        sqlAluno=sqlAluno+sqlAluno2
        db.query(sqlAluno)
